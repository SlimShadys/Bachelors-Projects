...
public class ProvaDB20170301 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			System.out.println("\n Il contenuto della vista LibriSottoScorta_HB è:");
			...
			System.out.println("\n Il titolo del libro con il numero più basso di copie disponibili fra quelli sotto scorta presso la filiale di nome 'Henrys Brentwood' è:");
