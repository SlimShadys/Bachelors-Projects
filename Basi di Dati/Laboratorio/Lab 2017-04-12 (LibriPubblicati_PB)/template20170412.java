...
public class ProvaDB20170412 {
	...
	public static void main(String[] args) {
		...
		try {
			...
			/*
			  creazione di una connessione al database HenrysBooksDB20170412
			...
			System.out.println("\n Per ciascun libro pubblicato dall’editore di nome 'Pocket Books', il titolo, il cognome del primo autore ed il numero totale di copie disponibili presso le filiali Henrys Books è:");
